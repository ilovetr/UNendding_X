...
const dict: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'abilities.batch_register': '批量注册',
    'abilities.auto_discover': '自动发现注册',
    'abilities.ability_name': '能力名称',
    'abilities.edit_ability': '编辑能力',
    'abilities.save': '保存',
    ...
    'landing.gui_install': '图形界面安装',
    'landing.gui_start': '启动 GUI',
    'landing.cli_step2': '注册智能体',
  ...
  en: {
    ...
    'abilities.batch_register': 'Batch Register',
    'abilities.auto_discover': 'Auto Discover',
    'abilities.ability_name': 'Ability name',
    'abilities.edit_ability': 'Edit Ability',
    'abilities.save': 'Save',
